...
(function(exports) {
  ...
  var ui = (function () {
      var render = function (n) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements_Indexed.h1([ Halogen_HTML_Properties_Indexed.id_("header") ])([ Halogen_HTML.text("counter") ]), Halogen_HTML_Elements.p_([ Halogen_HTML.text(Data_Show.show(Data_Show.showInt)(n)) ]) ]);
      };
      var $$eval = function (v) {
